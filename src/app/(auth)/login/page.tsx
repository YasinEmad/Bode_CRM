        ...
        <div className="flex items-center justify-center md:items-start md:justify-start p-4 md:-ml-16 md:-mt-20 md:ml-1">
          <div className="w-48 h-48 md:w-80 md:h-80 flex items-center">
            <img
              ...
              style={{
                transform: logoVisible ? 'translateX(0)' : 'translateX(-100%)',
                opacity: logoVisible ? 1 : 0,
                transition: 'transform 700ms cubic-bezier(0.22, 1, 0.36, 1), opacity 700ms ease',
              }}
              onLoad={() => {
                /* ensure image renders without flicker */
              }}
            />
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className='w-full px-4 py-3 border border-indigo-500 bg-indigo-900/30 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-transparent text-slate-100 placeholder-indigo-300 transition-all'
